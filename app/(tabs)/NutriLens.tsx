...
import {
  ...
  takePicture,
} from "../../services/nutricameraservice";
...
export default function NutriLensScreen() {
  ...
  const [foodHistory, setFoodHistory] =
    useState<FoodItem[]>(initialFoodHistory);
  ...
  const handleTakeFoodPicture = async () => {
    ...
    if (uri) {
      setImageUri(uri);
      setLoading(false); // pastikan reset dulu
      await new Promise((r) => setTimeout(r, 100)); // tunggu sebentar
      setLoading(true);
      ...
      try {
        // Simulasi pengenalan makanan dengan delay
        setTimeout(() => {
          // Dalam aplikasi nyata, ini akan memanggil API pengenalan makanan
          const foods = [
            {
            ...
            <View className="flex-1">
              <View className="p-4">
                <Text className="text-center text-gray-600 mb-4">
                  Cukup arahkan kamera ke makananmu, lalu tekan tombol untuk
                  melihat nutrisinya.
                </Text>
              </View>
                  ...
                  <View className="absolute inset-0 items-center justify-center">
                    <View className="bg-white p-4 rounded-lg w-4/5 items-center">
                      ...
                      <Text className="text-center">
                        Tunggu sebentar, NutriLens sedang menganalisis gambar
                      </Text>
                    </View>
                  </View>
                </View>
              ...
              {analysisComplete && (
                <>
                      ...
                      <View className="flex-1">
                        <View className="flex-row items-center mb-1">
                          ...
                          <Text className="text-orange-500 font-bold ml-1">
                            Gambar selesai dianalisis
                          </Text>
                        </View>
                        <Text className="text-gray-700 text-xs">
                          Berikut item dan kandungan nutrisi makananmu. Jika ada
                          yang terlewat, silahkan tambahkan manual.
                        </Text>
                      </View>
                    </View>
                  </View>
                  ...
                  >
                    ...
                    <Text className="color-[#fe572f] font-bold ml-2">
                      Tambah Item
                    </Text>
                  </TouchableOpacity>
          ...
          {activeTab === "NutriKu" ? (
            ...
            <View className="items-center justify-center py-10">
              <Text className="text-gray-500">
                Fitur ResepKu akan segera hadir!
              </Text>
            </View>
          )}
        </ScrollView>
